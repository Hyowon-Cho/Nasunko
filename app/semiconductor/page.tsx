  ...
  return (
    <main className="main">
      <section className="hero">
        ...
        <p className="page-subtitle">SOXX, SMH와 주요 칩 종목의 야간 흐름을 나스닥100 선물과 함께 확인합니다.</p>
      </section>
      ...
      <section className="grid two section">
        <article className="card card-inner info-card"><h2>미국 반도체 지수, 왜 한국 투자자가 볼까?</h2><p>한국 증시는 메모리, 파운드리, 장비 밸류체인의 비중이 큽니다. 미국 반도체 ETF와 대장주의 야간 움직임은 다음 국내장 수급과 갭 출발을 가늠하는 참고 지표가 됩니다.</p></article>
