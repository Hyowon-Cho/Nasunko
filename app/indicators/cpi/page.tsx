...
export const metadata: Metadata = {
  title: "나선코 - 미국 CPI 상세",
  description: "미국 CPI 최신 발표값, 예상, 이전치와 나스닥100 선물의 관계를 확인하세요."
};
  ...
  return (
    <main className="main">
      ...
      <section className="grid two section">
        ...
        <article className="card card-inner info-card wide"><h2>나스닥100 선물과의 관계</h2><p>CPI 발표 직후에는 미 국채금리와 달러가 먼저 반응하고, 그 움직임이 나스닥100 선물의 변동성으로 이어지는 경우가 많습니다.</p></article>
      </section>
    </main>
  );
}
