...
export const metadata: Metadata = {
  title: "나선코 - 미국 PPI 상세",
  description: "미국 PPI 최신 발표값, 예상, 이전치와 나스닥100 선물의 관계를 확인하세요."
};
  ...
  return (
    <main className="main">
      ...
      <section className="grid two section">
        ...
        <article className="card card-inner info-card wide"><h2>나스닥100 선물과의 관계</h2><p>PPI가 높으면 금리 인하 기대가 약해지고, 낮으면 성장주 선호가 회복되는 식으로 나스닥100 선물에 영향을 줄 수 있습니다.</p></article>
      </section>
    </main>
  );
}
