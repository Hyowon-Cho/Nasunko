...
export const mockNews: NewsItem[] = [
  { id: "n1", time: "05:54", title: "나스닥100 선물, 반도체 강세에 야간장 고점 재시도", category: "반도체", tags: ["NQ", "SOXX"], likes: 42, dislikes: 4, comments: 13 },
  ...
  { id: "n6", time: "02:15", title: "FOMC 의사록 대기, 선물 시장은 금리 경로 문구에 집중", category: "FOMC", tags: ["FOMC", "Fed"], likes: 24, dislikes: 6, comments: 14 },
  { id: "n7", time: "01:30", title: "다음 CPI 발표 앞두고 전월비 서비스 물가가 핵심 변수", category: "경제지표", tags: ["CPI", "인플레"], likes: 31, dislikes: 2, comments: 10 },
  { id: "n8", time: "00:48", title: "코스피 야간 흐름, 미국 선물과 환율 영향권", category: "코스피", tags: ["코스피", "야간선물"], likes: 16, dislikes: 1, comments: 7 }
];
